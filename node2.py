...
print("")
print("[~/node2.py] Beginning training...")
print("")
...
for _ in range(epochs):
  ...
  if _ % (epochs // 10) == 0:
    ...
    print(f"[~/node2.py] Epoch {_}, MSE: {mse:.6f}")
...
print("")
print("[~/node2.py] Predictions after training:")
print(final_output)
print("")
print("[~/node2.py] Simplified Predictions:")
print(predicted_bits)
print("")
print("[~/node2.py] Correct Bits:")
print(y)
print("")
